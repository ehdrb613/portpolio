<?php include $_SERVER["DOCUMENT_ROOT"]."/site1/include/global.php"; ?>
<!DOCTYPE html>
<html>
<head>
	<title>그리다</title>
...
//window.open('sub/main_in.html','popup','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=yes,width=100%,height=auto')
...
<div id="base">
	...
	?>
		<!--로그인 되었을때-->
		<li><input class="login_btn" type="button" value="로그아웃"></li>
	<?php
	}
	?>	
	...
	<section>
		...
		<div id="free_test_h" class="main_menu">
			<a href="htp_test/m_htp.html"><p class="menu_name">그림 진단 GO</p></a>
		</div>
		<!--그림진단-->
		...
		<div id="cont_index" class="main_menu">
			<a href="sub/storage.php"><p class="menu_name">상담 보관함</p></a>
		</div>
		<!--공지사항-->
		<div id="notice_main" class="main_menu">
			<a href="sub/공지사항.html"><p class="menu_name">공지 사항</p></a>
		</div>
		<!--고객센터-->
		<div id="customer_center" class="main_menu">
			<a href="sub/고객센터.html"><p class="menu_name">고객 센터</p></a>
		</div>
