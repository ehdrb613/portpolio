<?
    ...
    if($result)
    {
      $sql="UPDATE grida_htp SET p1 = 'Y'";
      $result = mysql_query($sql);
      echo "<script>alert('다음 검사를 진행합니다.'); location.href='../htp_test/p_test2.html';</script>";
    }
    else
    {
      echo "<script>alert('질문을 다시 적어주세요.'); location.href='../htp_test/p_q1.html';</script>";
    }
    mysql_close($connect);
